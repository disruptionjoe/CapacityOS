...
### Software Engineer
Clean change. Remove the General section from the dashboard template. Update error handling to say "place item in Flow/inbox/ for triage" instead of "place item in General." Low risk, no dependencies.
...
All three personas agree — safe to implement.
